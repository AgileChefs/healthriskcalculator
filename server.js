...
app.post("/calculate-risk", (req, res) => {
    ...
    else { bmiCategory = "Obese"; bmiPoints = 75; }
    ...
    else { bpCategory = "Hypertensive Crisis"; bpPoints = 100; }
    ...
    res.json({ bmi, bmiCategory, bpCategory, totalScore, riskLevel });
});
